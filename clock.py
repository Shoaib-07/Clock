...
lab_hr_txt=Label(clock,text="Hour", font=("Times New Roman", 25, "bold"), bg="red", fg="White")
...
#*****************date*******************
lab_date=Label(clock,text="00", font=("Times New Roman", 50, "bold"), bg="red", fg="White")
...
lab_mo_txt=Label(clock,text="Month", font=("Times New Roman", 25, "bold"), bg="red", fg="White")
